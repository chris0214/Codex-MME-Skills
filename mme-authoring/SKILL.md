---
name: mme-authoring
description: Use when Codex needs to write or modify MMD/MME shader files such as .fx or .fxsub, including model shaders, post effects, render-target chains, controller-driven effects, or ray-mmd/sdPBR/ExcellentShadow-compatible effect code.
---
