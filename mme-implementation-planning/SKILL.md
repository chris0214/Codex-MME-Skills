...
description: Use when Codex needs to plan MMD/MME .fx/.fxsub implementation details such as file layout, render targets, MMDPass techniques, postprocess scripts, DefaultEffect routing, controller parameters, examples, and debug checkpoints before writing code.
---
