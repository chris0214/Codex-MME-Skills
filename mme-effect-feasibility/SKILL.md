...
description: Use when Codex must decide whether an MMD/MME visual effect can be implemented, whether it should be standalone or framework-based, and what shader model, render target, controller, hardware, or compatibility risks apply.
---
