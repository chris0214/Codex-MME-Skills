...
- `H:\MME编写\Official MME Sample\MME-Reference翻译版.md` is a renamed DOCX/ZIP; extract `word/document.xml` when needed.

Prefer `REFERENCE.txt` and official sample `.fx` files when translations disagree.
