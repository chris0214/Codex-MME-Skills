...
description: Use when Codex needs to review MMD/MME .fx/.fxsub shader code before runtime testing, looking for HLSL compile issues, MME Script mistakes, missing passes, wrong MMDPass variants, render target problems, includes, encoding, or framework integration errors.
---
