...
description: Use when Codex needs to interpret a user's desired MMD/MME visual effect, look, shader behavior, postprocess, material response, lighting change, shadow style, or ray-mmd/sdPBR/MME effect idea before feasibility or implementation.
---
